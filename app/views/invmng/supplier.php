        ...
        <div class = "dashboard_sidebar" id="dashboard_sidebar">
            ...
            <div class="dashboard_sidebar_menu">
                <ul class="dashboard_menu_list">
                    <li class="menuActive">
                        <a href="/dashboard"><i class="fa fa-dashboard"></i><span class="menuText">Dashboard</span>
                    </li>
                    <li> 
                        <a href="/product"><i class="fa-solid fa-flask"></i><span class="menuText">Product</span> 
                    </li>
                    <li>
                        <a href="/supplier"><i class="fa-solid fa-users"></i><span class="menuText">Supplier</span> 
                    </li>
                    <li>
                        <a href="/order'"><i class="fa-solid fa-cart-shopping"></i><span class="menuText">Purchase Order</span></a>
                    </li>
                </ul>
            </div>    
        </div>            
