...
<head>
    ...
    <link rel="stylesheet" href="<?php echo APPROOT.'/public/css/receptdashboard/payment_form.css'?>">
    <script src="<?php echo APPROOT.'/public/js/receptdashboard/patient.js';?>"></script>
    <!-- static icons -->
