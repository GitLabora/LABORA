...
function renderCalendar() {
  ...
  for (let i = 1; i <= lastDayDate; i++) {
    ...
    if (
      ...
      days += `<div class="day today"><a href="get_available_times/${date_var}" style="text-decoration:none;color:black;padding:9px;">${i}</a></div>`;
    } else {
      //else dont add today
      days += `<div class="day"><a href="get_available_times/${date_var}" style="text-decoration:none;;color:black;padding:9px;">${i}</a></div>`;
    }
  }
